              ...
              <div class="col-2">
                <div class="input-group">
                  ...
                  <div class="input-group-icon">
                    <input class="input--style-4 js-datepicker" type="date" name="date" placeholder="oy/kun/yil">
            ...
            <div class="input-group">
             ...
             <div class="alone_select">
              <div class="input-group">
                ...
                <input class="input--style-4" type="text" name="type_disease">
              </div>
             </div>
              </div>
            ...
            <div class="row row-space">
              <div class="col-4">
                <div class="input-group">
                  ...
                  <input class="input--style-4" type="text" name="psr">
                </div>
              </div>
              <div class="col-4">
                <div class="input-group">
                  ...
                  <input class="input--style-4" type="text" name="alt">
                </div>
              </div>
              <div class="col-4">
                <div class="input-group">
                  ...
                  <input class="input--style-4" type="text" name="ast">
                </div>
              </div>
              <div class="col-4">
                <div class="input-group">
                  ...
                  <input class="input--style-4" type="text" name="billuribin">
                </div>
              </div>
            </div>
            <div class="row row-space">
              <div class="col-4">
                <div class="input-group">
                  ...
                  <input class="input--style-4" type="text" name="ishqor">
                </div>
              </div>
              <div class="col-4">
                <div class="input-group">
                  ...
                  <input class="input--style-4" type="text" name="timol">
                </div>
              </div>
              <div class="col-4">
                <div class="input-group">
                  ...
                  <input class="input--style-4" type="text" name="igg">
                </div>
              </div>
              <div class="col-4">
                <div class="input-group">
                  ...
                  <input class="input--style-4" type="text" name="igm">
                </div>
              </div>
            </div>
